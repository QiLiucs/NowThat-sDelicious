...
function searchResultsHTML(stores) {
    return stores.map(function (store) {
        return "\n        <a href=\"/store/" + store.name + "\" class=\"search__result\">\n        <strong>" + store.name + "</strong>\n        </a>\n        ";
    }).join("");
}
...
function typeAhead(search) {
    ...
    searchInput.on("keyup", function (e) {
        ...
        if (e.keyCode === 40 && current) {
            next = current.nextElementSibling || items[0] || items;
        } else if (e.keyCode === 40) {
            next = items[0] || items;
        } else if (e.keyCode === 38 && current) {
            next = current.previousElementSibling || items[items.length - 1] || items;
        } else if (e.keyCode === 38) {
            next = items[items.length - 1] || items;
...
var _showGoogleMap = __webpack_require__(12);

var _showGoogleMap2 = _interopRequireDefault(_showGoogleMap);
...
(0, _showGoogleMap2.default)((0, _bling.$)('#single__gmap'), (0, _bling.$)('#storeLat'), (0, _bling.$)('#storeLng'));
